package com.example.officehero.data.network.di

import com.example.officehero.constants.network.BASE_URL
import com.example.officehero.data.local.sharedPreference.SharedPreferenceUtil
import com.example.officehero.data.network.interceptor.di.AuthInterceptor
import com.example.officehero.data.network.interceptor.qualifiers.WithInterceptor
import com.example.officehero.data.network.interceptor.qualifiers.WithoutInterceptor
